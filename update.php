                    ...
                    <div class="col-7">
                        ...
                        <select name="services" class="form-select mb-2" id="inputSelect" required>
                            <option value="" disabled selected>Service</option>
                                <option value="reading" <?php if ($record["services"] == "reading") { echo "selected"; } ?>>Reading</option>
                                <option value="our product" <?php if ($record["services"] == "our_product") { echo "selected"; } ?>>Our product</option>
                        </select>
                    </div>
